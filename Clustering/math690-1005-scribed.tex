...
\begin{document}
\lecture{Dimension Reduction}{October 5, 2017}{Xiuyuan Cheng}{Dev Dabke and Andrew Cho}
...
\begin{dfn}[Volume Set]{dfn:volume-set}

$ \vol(A) = \sum_{i \in A} d_i $ is the sum of degrees.

\end{dfn}

\begin{dfn}[Normalized Cut Partition]{dfn:normalized-cut-partition}
